...
row_drugstore_6 = string_to_list(GetVar('vector_6'))

if row_drugstore_6[4] == ' No se encontro dato':             
    price_as_number_6 = 'NULL'    #isnan()
else:
    price_as_number_6 = row_drugstore_6[4].replace("MXN","").replace("$","").replace(",","")

SetVar('vector_6',row_drugstore_6)
...
keyword = "{keyword}"
drugstore_site = "{tux_6}"
product_title = row_drugstore_6[2]
product_desc =row_drugstore_6[3]
price = price_as_number_6 
