...
row_drugstore_1 = string_to_list(GetVar('vector_1'))

if row_drugstore_1[4] == ' No se encontro dato':             
    price_as_number_1 = 'NULL'    #isnan()
else:
    price_as_number_1 = row_drugstore_1[4].replace("MXN","").replace("$","").replace(",","")

SetVar('vector_1',row_drugstore_1)
...
keyword = "{keyword}"
drugstore_site = "{tux_1}"
product_title = row_drugstore_1[2]
product_desc =row_drugstore_1[3]
price = price_as_number_1 
