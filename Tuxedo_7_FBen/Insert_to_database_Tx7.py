...
row_drugstore_7 = string_to_list(GetVar('vector_7'))

if row_drugstore_7[4] == ' No se encontro dato':             
    price_as_number_7 = 'NULL'    #isnan()
else:
    price_as_number_7 = row_drugstore_7[4].replace("MXN","").replace("$","").replace(",","")

SetVar('vector_7',row_drugstore_7)
...
keyword = "{keyword}"
drugstore_site = "{tux_7}"
product_title = row_drugstore_7[2]
product_desc =row_drugstore_7[3]
price = price_as_number_7 
