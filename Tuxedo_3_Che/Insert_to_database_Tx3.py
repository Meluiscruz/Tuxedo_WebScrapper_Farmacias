...
row_drugstore_3 = string_to_list(GetVar('vector_3'))

if row_drugstore_3[4] == ' No se encontro dato':
    price_as_number_3 = 'NULL'               #isnan()
else:
    price_as_number_3 = row_drugstore_3[4].replace("MXN","").replace("$","").replace(",","")

SetVar('vector_3',row_drugstore_3)
...
keyword = "{keyword}"
drugstore_site = "{tux_3}"
product_title = row_drugstore_3[2]
product_desc =row_drugstore_3[3]
price = price_as_number_3 
